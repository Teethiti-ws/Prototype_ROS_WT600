...
const int right_front = 51;//DIR1
const int left_back = 10;
const int left_front = 50; //DIR2
const int right_pwm = 7; //6; //PWM2
const int left_pwm = 6;  //9  //PWM1
int pwm = 255; //62
...
void MoveFwd() {
     ...
     digitalWrite(right_front,HIGH);//LOW
     digitalWrite(left_front, HIGH);//LOW
...
void MoveBack() {
     analogWrite(right_pwm, pwm);
     analogWrite(left_pwm, pwm);
     digitalWrite(right_back, LOW);//HIGH
     digitalWrite(left_back, LOW); //HIGH
     digitalWrite(right_front,LOW);
     digitalWrite(left_front, LOW);
}
